...
public class JwtProperties {
     ...
     * Значение проверяется на старте в конструкторе JwtService: пустой, слишком короткий или
     * оставшийся dev-дефолтом секрет вне профиля dev роняет контекст, а не работает молча.
     */
