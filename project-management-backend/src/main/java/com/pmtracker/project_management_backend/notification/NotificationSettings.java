...
public class NotificationSettings {
     ...
     * <p>
     * Первым этой веткой пользуется {@code task_created} (4.16), и своего флага у него нет
     * намеренно. Этот тип приходит только тем, кто выбрал по конкретному проекту режим ALL,
     * — то есть выключателем ему служит сам этот выбор. Глобальная галочка «не писать о
     * новых задачах» была бы вторым выключателем того же самого, причём в другом месте
     * интерфейса, и первым же вопросом к ней стало бы, какой из двух главнее.
     */
