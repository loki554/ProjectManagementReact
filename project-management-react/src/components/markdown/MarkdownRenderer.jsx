...
const markdownClass =
  ...
  '[&_li]:mb-0.5 [&_a]:text-purple-600 [&_a]:underline [&_strong]:font-semibold dark:[&_a]:text-purple-400 ' +
  '[&_code]:rounded [&_code]:bg-gray-100 [&_code]:px-1 [&_code]:py-0.5 [&_code]:text-xs dark:[&_code]:bg-gray-700 ' +
  '[&_pre]:mb-2 [&_pre]:overflow-x-auto [&_pre]:rounded [&_pre]:bg-gray-100 [&_pre]:p-3 dark:[&_pre]:bg-gray-700 ' +
